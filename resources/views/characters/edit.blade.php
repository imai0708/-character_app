        ...
        <form action="{{ route('characters.update', $character) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="title"
                    ...
                    required placeholder="タイトル" value="{{ old('title', $character->title) }}">
            </div>
            <div class="mb-4">
                ...
                @foreach ($categories as $category)
                    <div>
                        <input type="radio" name="category_id" id="category{{ $category->id }}"
                            value="{{ $category->id }}"
                            {{ old('category_id', $character->category_id) == $category->id ? 'checked' : '' }}>
            ...
            <div class="mb-4">
                ...
                <img src="{{ Storage::url($character->image_path) }}" alt="" class="mb-4 md:w-2/5 sm:auto">
